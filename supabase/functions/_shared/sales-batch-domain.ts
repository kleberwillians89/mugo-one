...
export function parseTabularSalesBatch(rawText:string):ParsedSalesBatch{
  ...
  return{source_format:'tsv',perfume:groups[0]?.perfume??'',bottle_number:null,original_volume_ml:null,quote_per_ml:null,recrimping_fee:null,apc_volume_ml:null,apc_extra:null,deadline_raw:null,deadline_day_month:null,business_days:null,announced_balance_ml:null,sales,groups,availability_rows:availabilityTotals.rows,availability_ml:availabilityTotals.volume_ml,availability_amount:availabilityTotals.amount,totals:{sales:sales.length,volume_ml:totalMl,amount:totalAmount,calculated_balance_ml:null,volume_consistent:true},raw_text:raw}
}
