...
-- ==========================================================================
-- IMPORTAÇÃO INCREMENTAL — preservação de campos e multiplicidade no mesmo lote
-- --------------------------------------------------------------------------
...
--   - a proteção contra duplicata pré-existente continua ativa;
--   - idempotência por file_hash continua bloqueando uma segunda escrita.
-- ==========================================================================
