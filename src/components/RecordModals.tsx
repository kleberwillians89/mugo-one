...
import { ClientInput, createClient, createSale, parseSaleAssistant, searchClients, searchPerfumes, updateClient } from '../lib/records'
import { parseBrazilianMoney } from '../lib/importer'
import { Divider, EntityCombobox, EntityOption } from './ui'
...
export function SaleModal({ close }: { close:()=>void }) {
  ...
  const [saleType,setSaleType]=useState<'APC'|'SPLIT'>('SPLIT'),[ml,setMl]=useState(''),[perfume,setPerfume]=useState<EntityOption|null>(null),[credit,setCredit]=useState('')
