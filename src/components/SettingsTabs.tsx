...
export function SettingsTabs({ active }: { active: 'frete' | 'equipe' | 'entradas-de-leads' | 'comunicacoes' | 'fiscal' }) {
  ...
  if (!canTeam && !canLeadIntake && !canCommunications && !canFiscal) return null
  return (
