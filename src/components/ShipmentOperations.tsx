...
export function ShipmentDetailsPage({shipmentId}:{shipmentId:string}){
  const [shipment,setShipment]=useState<OperationalShipment|null>(null),[editing,setEditing]=useState(false),[error,setError]=useState(''),[busy,setBusy]=useState(''),[feedback,setFeedback]=useState(''),[isAdmin,setIsAdmin]=useState(false)
