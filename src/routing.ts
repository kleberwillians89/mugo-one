import {
  Boxes, CircleDollarSign, Compass, FileSpreadsheet, FileText, Home, Import, Lightbulb, Package, Radar, Settings, ShoppingBag, Sparkles, Truck, UserRound, UsersRound,
} from 'lucide-react'
...
export type Page = 'Visão Geral'|'Torre de Controle'|'Clientes'|'Vendas'|'Produtos'|'Planilha'|'Cobranças'|'Entregas'|'Estoque'|'Relatórios'|'Importação'|'IA'|'Insights'|'Radar'|'Interessados'|'Configurações'
...
export const routes:Record<Page,string>={'Visão Geral':'/','Torre de Controle':'/torre-de-controle','Clientes':'/clientes','Vendas':'/vendas','Produtos':'/produtos','Planilha':'/planilha','Cobranças':'/cobrancas','Entregas':'/entregas','Estoque':'/estoque','Relatórios':'/relatorios','Importação':'/importacao','IA':'/ia','Insights':'/insights','Radar':'/radar','Interessados':'/interessados','Configurações':'/configuracoes'}
